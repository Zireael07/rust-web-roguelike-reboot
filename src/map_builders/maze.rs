...
impl MazeBuilder {
    ...
    fn build(&mut self) {
        ...
        // Maze starts at Cell(1,1) which corresponds to Position 2,2
...
impl Cell {
    ...
    //it's unsafe because it operates on raw pointers (*mut Cell)
...
//<'a> is a lifetime specifier because we need RNG
impl<'a> Grid<'a> {
