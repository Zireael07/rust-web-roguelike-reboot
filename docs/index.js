...
const initButtons = () => {
    ...
    //     wasm_bindgen.setHTMLCommand(wasm_bindgen.Command.MoveUp);
    ...
    //   });
      ...
      //   console.log(wasm_bindgen.Command);
      //   wasm_bindgen.setHTMLCommand(wasm_bindgen.Command.MoveRight);
      //   //console.log("After move: " + game.pos_x() + " " + game.pos_y());
      // });
      ...
      //   console.log(wasm_bindgen.Command);
      //   wasm_bindgen.setHTMLCommand(wasm_bindgen.Command.MoveDown);
      //   //console.log("After move: " + game.pos_x() + " " + game.pos_y());
      // });
    }